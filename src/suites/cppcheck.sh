...
# | Variable                           | CLI flag                            |
# |------------------------------------|-------------------------------------|
# | ACTUARY_CPPCHECK_LIBRARY                | --library                           |
# | ACTUARY_CPPCHECK_SUPPRESSIONS           | --timeout-multiplier                |
# | ACTUARY_CPPCHECK_ARGS                   | additional command-line arguments   |
#
actuarysuite_cppcheck() {
